...
def get_movie_cache_invalidator(cache: RedisDep) -> MovieCacheInvalidator:
...
MovieCacheInvalidatorDep: TypeAlias = Annotated[MovieCacheInvalidator, Depends(get_movie_cache_invalidator)]
