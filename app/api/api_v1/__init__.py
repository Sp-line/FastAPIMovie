...
router.include_router(movie_country_router, tags=["Movie-Country-Associations"])
router.include_router(movie_genre_router, tags=["Movie-Genre-Associations"])
router.include_router(movie_person_router, tags=["Movie-Person-Associations"])
